<?php
require 'config.php';
require 'social_login.php'; // Assuming this handles Google login
...
// Handle social login
if (isset($_GET['social']) && $_GET['social'] === 'google') {
    handleGoogleLogin();
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <style>
        ...
        .google-btn { display: flex; align-items: center; justify-content: center; border: 1px solid #0d7cff; color: #222; background: #fff; border-radius: 5px; padding: 10px; font-size: 1em; cursor: pointer; margin: 0 auto 18px auto; width: 90%; text-decoration: none; }
...
<body>
    <div class="container">
        ...
        <div class="right">
            ...
            <a class="google-btn" href="?social=google">
